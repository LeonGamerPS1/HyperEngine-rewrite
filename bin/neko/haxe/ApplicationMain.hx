...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("NewProjecter", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		app.meta.set("company", "sexy bitch");
		app.meta.set("file", "NewProjecter");
		app.meta.set("name", "New Projecter");
		app.meta.set("packageName", "NewProjecter");
		...
		#elseif air
		app.window.title = "New Projecter";
		#else
