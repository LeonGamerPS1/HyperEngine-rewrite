...
class Character extends FlxSprite
{
	...
	public function new(x:Float = 0, y:Float = 0, ?character:String = 'bf', ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			default:
				var characterPath:String = 'assets/characters/' + curCharacter + '.json';
				#if MODS_ALLOWED
				...
				#end
				{
					path = 'assets/characters/' + DEFAULT_CHARACTER + '.json'; // If a character couldn't be found, change him to BF just to prevent a crash
				}
				...
				if (OpenFlAssets.exists('assets/images/' + json.image + '.txt'))
				{
