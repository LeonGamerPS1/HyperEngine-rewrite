...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("fnfshit", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("fnfshit", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "fnfshit";
		app.meta["name"] = "fnfshit";
